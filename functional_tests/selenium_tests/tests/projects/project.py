...
class EditProject(SeleniumTestCase):
    ...
    def test_edit_project(self):
        ...
        self.wd.wait_for_xpath("//h2[contains(text(), 'Project Overview')]")
        self.open("/projects/project-1/edit/")
        self.wd.wait_for_css(".modal-title")
        self.wd.find_css('#id_details-description').clear()
        self.wd.find_css('#id_details-description').send_keys("Test project-1 description edited.")

...
class AddLocationResource(SeleniumTestCase):
    ...
    def xtest_attach_existing_resource_to_new_location(self):
    ...
    def xtest_attach_existing_resource_to_existing_location(self):
        projects_page = ProjectsPage(self.wd, self)
        projects_page.go_to()
    ...
    def xtest_attach_new_resource_to_existing_location(self):
        projects_page = ProjectsPage(self.wd, self)
        projects_page.go_to()
